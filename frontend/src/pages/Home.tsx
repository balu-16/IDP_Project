...
const Home: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg font-medium shadow-md glow-primary hover:glow-accent transition-all"
            >
              Get Started
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="glass-panel p-8 text-center hover:glow-primary transition-all group"
              >
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-border p-8">
